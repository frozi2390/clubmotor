            ...
            <div class="pcoded-content">
                <div class="pcoded-inner-content">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="user" action="tambah/tambah-produk.php" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <input type="file" class="form-control form-control-user" id="gambar"
                                                name="gambar" aria-describedby="emailHelp" placeholder="Gambar">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="nama_barang"
                                            name="nama_barang" aria-describedby="emailHelp" placeholder="Nama Barang">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="fiter"
                                            name="filter" aria-describedby="emailHelp" placeholder="Kategori Barang">
                                        </div>
                    ...
                    <table id="example" class="display" style="width:100%">
                        ...
                        ?>
                            <tr>
                                <td><img src="assets/img/<?= $tampil['gambar']; ?>" class="img-thumbnail w-50"></td>
                                <td><?= $tampil['nama_barang']; ?></td>
                                <td><?= $tampil['filter']; ?></td>
                                <td>
                                    <a href="hapus/hapus-produk.php?id_produk=<?= $tampil['id_produk']?>" class="btn btn-danger">Hapus</a>
                                </td>
