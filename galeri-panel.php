                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="user" action="tambah/tambah-galeri.php" method="POST" enctype="multipart/form-data">
                    ...
                    <table id="example" class="display" style="width:100%">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="hapus/hapus-galeri.php?id_galeri=<?= $tampil['id_galeri']?>" class="btn btn-danger">Hapus</a>
                                </td>
