...
//     $fileName = $_FILES['image']['tmp'];


//     $validImageExtension = ['jpg','jpeg','png'];
//     $validExtension = explode('.',$fileName);
//     $imageExtension = strtolower(end($imageExtension));
//     if(!in_array($imageExtension,$validImageExtension)){
//         echo
//         "<script>alert('Invalid Image Extentions')</script>";
            ...
            <div class="pcoded-content">
                <div class="pcoded-inner-content">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="user" action="tambah/tambah-artikel.php" method="POST" enctype="multipart/form-data">
                    ...
                    <table id="example" class="display" style="width:100%">
                        ...
                        ?>
                            <tr>
                                <td><img src="assets/img/<?= $tampil['gambar']; ?>" class="img-thumbnail"></td>
                                <td><?= $tampil['judul']; ?></td>
                                <td><?= $tampil['isi']; ?></td>
                                <td>
                                    <a href="hapus/hapus-artikel.php?id_artikel=<?= $tampil['id_artikel']?>"  class="btn btn-danger">Hapus</a>
                                </td>
