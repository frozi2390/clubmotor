      ...
      <div class="container">
        ...
        <div class="row ">
          ...
          <div class="col-md-6 text-center">
            <div class="card-visi">
              <h3>Misi</h3>
              <p>DENGAN ADANYA KOMUNITAS ANAK LANGIT CLUB INI DIHARAPKAN BISA UNTUK AJANG SILAHTURAHMI UNTUK PARA ANGGOTA. DAN SELAIN ITU SEMOGA KOMUNITAS INI BISA MEMBUAT KEBERSAMAAN YANG KUAT UNTUK SEMUA ANGGOTA. CLUB INI INGIN MENYATUKAN SEMUA PIKIRAN-PIKIRAN YANG BERBEDA UNTUK MENUJU SATU TUJUAN YANG SAMA</p>
            </div>
          </div>
    ...
    <section id="profile" class="profile">
      <div class="container">
        ...
        <div class="text-center">
          <h3>Profil</h3>
          <p> Club ini hanya sebatas komunitas pencinta motor besar, yang bertujuan menyalurkan hobi dan kegabutannya kepada sepeda motor , kelebihan dari club ini adalah membantu masyarakat dalam mengatasi permasalahan yang ada dan gotoroyong open donasi bagi yang membutuhkan</p>
        </div>
        ...
        <div class="row mx-auto mt-3">
          <div class="col-lg-4 col-sm-6 mx-auto ">
            <div class="card" style="width: 18rem;">
              <img src="assets/img/artikel1.png" class="card-img-top" alt="...">
              <div class="card-body my-3">
                <h5 class="card-title ">Membantu Masyarakat</h5>
                <p class="card-text">Kegiatan setiap minggunya membantu masyarakat dalam mengatasi permasalahan yang ada dilingkungan dan melakukan pemungutan sampah agar ligkungan bersih dan segar.</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-sm-6 mx-auto">
            <div class="card" style="width: 18rem;">
              <img src="assets/img/artikel2.png" class="card-img-top" alt="...">
              <div class="card-body my-3">
                <h5 class="card-title ">Lomba Bapal Motor</h5>
                <p class="card-text">Mendapatkan Juara 1 pada balapan motor sircuit yang dimengkan oleh bayu sebagai perwakilan dari ALC </p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-sm-6 mx-auto">
            <div class="card" style="width: 18rem;">
              <img src="assets/img/artikel3.png" class="card-img-top" alt="...">
              <div class="card-body my-3">
                <h5 class="card-title ">Bakti Sosial</h5>
                <p class="card-text">Melakukan kegiatan bakti sosial ke panti asuhan amal jaya sebagai salah satu bentuk kepedulian sosial mereka pada anak yatim tersebut. Aktivitas penggalangan dana ini untuk donasi atau bantuan bagi anak-anak yatim ini, dilakukan sebelumnya.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-4 col-sm-6">
            <div class="thumbnail">
              <div class="img-container">
                <img src="assets/img/banner.jpg" alt="" class="image">
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-sm-6">
      ...
      <div class="container">
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <img src="assets/img/cloth.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>App 1</h4>
              <p>App</p>
              <a href="assets/img/cloth3.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="App 1"><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <img src="assets/img/cloth2.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Web 3</h4>
              <p>Web</p>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <img src="assets/img/part3.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>App 2</h4>
              <p>App</p>
              <a href="assets/img/part.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="App 2"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" data-gallery="portfolioDetailsGallery" data-glightbox="type: external" class="portfolio-details-lightbox details-link" title="Portfolio Details"><i class="bx bx-link"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <img src="assets/img/motor1.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Card 2</h4>
              <p>Card</p>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <img src="assets/img/motor2.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Web 2</h4>
              <p>Web</p>
              <a href="assets/img/motor2.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Web 2"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" data-gallery="portfolioDetailsGallery" data-glightbox="type: external" class="portfolio-details-lightbox details-link" title="Portfolio Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <img src="assets/img/part.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Card 1</h4>
              <p>Card</p>
