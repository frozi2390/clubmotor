                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Tambah Isi Content</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <form class="user" action="tambah/tambah-profil.php" method="POST">
                    ...
                    <table id="example" class="display" style="width:100%">
                        ...
                        ?>
                            <tr>
                                <td><?= $tampil['isi']; ?></td>
                                <td>
                                    <a href="hapus/hapus-profil.php?id_profil=<?= $tampil['id_profil']?>" class="btn btn-danger">Hapus</a>
                                </td>
